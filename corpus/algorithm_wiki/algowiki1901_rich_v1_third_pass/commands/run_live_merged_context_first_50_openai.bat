@echo off
REM Run live third-pass context first_50 with OpenAI
...
set "QML_MANIFEST=corpus\algorithm_wiki\algowiki1901_rich_v1_third_pass\manifests\merged_ready_public_context_recommendation.csv"
set "QML_PATH_COLUMN=public_context_path"
set "QML_ID_COLUMN=algorithm_id"
set "QML_REASONING_EFFORT=medium"
set "QML_OUTPUT_DIR=runs\algowiki_third_pass_merged_context_first50"
