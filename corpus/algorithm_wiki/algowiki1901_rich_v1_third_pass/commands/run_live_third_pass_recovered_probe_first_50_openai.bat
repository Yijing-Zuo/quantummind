...
set "QML_MANIFEST=corpus\algorithm_wiki\algowiki1901_rich_v1_third_pass\manifests\recovered_probe.csv"
set "QML_PATH_COLUMN=public_probe_path"
set "QML_ID_COLUMN=probe_id"
set "QML_REASONING_EFFORT=high"
set "QML_OUTPUT_DIR=runs\algowiki_third_pass_recovered_probe_first50"
