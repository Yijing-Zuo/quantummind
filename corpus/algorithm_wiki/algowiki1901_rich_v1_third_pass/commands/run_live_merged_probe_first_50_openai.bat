@echo off
REM Run live third-pass probe first_50 with OpenAI
...
set "QML_MANIFEST=corpus\algorithm_wiki\algowiki1901_rich_v1_third_pass\manifests\merged_ready_public_probe_recommendation.csv"
set "QML_PATH_COLUMN=public_probe_path"
set "QML_ID_COLUMN=probe_id"
set "QML_REASONING_EFFORT=high"
set "QML_OUTPUT_DIR=runs\algowiki_third_pass_merged_probe_first50"
