@echo off
REM Run live probe first_50 with OpenAI
...
set "QML_MANIFEST=corpus\algorithm_wiki\algowiki1901_rich_v1\manifests\ready_public_probe.csv"
set "QML_PATH_COLUMN=public_probe_path"
set "QML_ID_COLUMN=probe_id"
set "QML_REASONING_EFFORT=high"
set "QML_OUTPUT_DIR=runs\algowiki_rich_probe_first50"
