@echo off
REM Run live context first_50 with OpenAI
...
set "QML_MANIFEST=corpus\algorithm_wiki\algowiki1901_rich_v1\manifests\ready_public_context.csv"
set "QML_PATH_COLUMN=public_context_path"
set "QML_ID_COLUMN=algorithm_id"
set "QML_REASONING_EFFORT=medium"
set "QML_OUTPUT_DIR=runs\algowiki_rich_context_first50"
